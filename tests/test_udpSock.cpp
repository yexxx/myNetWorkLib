...
int main() {
    ...
    WarnL << "sockRecv: local: " << sockRecv->get_localIP() << ":" << sockRecv->get_localPort() << "   peer: " << sockRecv->get_peerIP() << ":"
          << sockRecv->get_peerPort();
    WarnL << "sockSend: local: " << sockSend->get_localIP() << ":" << sockSend->get_localPort() << "   peer: " << sockSend->get_peerIP() << ":"
          << sockSend->get_peerPort();
